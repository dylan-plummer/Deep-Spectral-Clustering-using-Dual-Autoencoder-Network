...
def run_net(data, params):
    ...
    for i in range(n_epochs):
        ...
        sc1 = axs[1][0].scatter(Z_tsne[:, 0], Z_tsne[:, 1], s=1, c=y_train_unlabeled, cmap=plt.cm.get_cmap("Set1", params['n_clusters']))
        ...
        cbar1.set_ticks(np.arange(params['n_clusters']))
        ...
        axs[1][1].scatter(matrix_reduce[:, 0], matrix_reduce[:, 1], s=1, c=y_train_unlabeled, cmap=plt.cm.get_cmap("Set1", params['n_clusters']))
        ...
        n_matrices = (i + 1) * params['batch_size'] * 1000
